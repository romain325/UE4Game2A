...
AWeapon::AWeapon()
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AWeapon::OnHit);		// set up a notification for when this component hits something blocking
...
void AWeapon::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	{
		OtherActor->TakeDamage(this->ImpactDamage.Damage, this->ImpactDamage, GetWorld()->GetFirstPlayerController(), this);
	}
}
